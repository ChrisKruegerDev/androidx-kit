...
class Rotate : Transition {
    ...
    override fun createAnimator(
        ...
        val startRotation = startValues.values[PROP_ROTATION] as Float? ?: 0f
        val endRotation = endValues.values[PROP_ROTATION] as Float? ?: 0f
    ...
    companion object {
        private const val PROP_ROTATION = "moviebase:rotate:rotation"
